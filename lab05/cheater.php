...
<html>
	...
	<body>
		...
		<?php
		$params = array("name", "id", "grade", "card_number", "card_type");
		$courses = array("cse326", "cse107", "cse607", "cin870");
		...
		--> 
		<h1>Sorry</h1>
			<p>You didn't provide a valid credit card number. <a href="index.php">Try again?</a></p>
		...
		<?php
			 ...
			 */
			$targetList = array("name", "id", "card_number", "card_type");
            $newArray = array();
